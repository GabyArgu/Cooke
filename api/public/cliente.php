    ...
    if (isset($_SESSION['id_cliente'])) {
        ...
        switch ($_GET['action']) {
            ...
            case 'readAll':
                ...
                break;
            // Accion de buscar información de los cliente disponibles------------------.     
            case 'search':
                ...
                break;
            // Accion de crear un nuevo cliente ------------------.       
            case 'create':
        ...
        switch ($_GET['action']) {
            case 'readUsers':
                //Verificamos si existen cliente registrados en la base de datos, para que en caso de no, registrar el primer cliente
                if ($cliente->readAll()) {
                    $result['status'] = 1;
                    $result['message'] = 'Existe al menos un cliente registrado';
                } else {
                    $result['exception'] = 'No existen cliente registrados';
                }
                break;
            ...
            case 'logIn':
                $_POST = $cliente->validateForm($_POST);
                if (!$cliente->checkUser($_POST['cliente'])) {
